...
ts.append(T(tag="ParamLabel/text",
    text="Link|Amount")
    .es("Intensidad|de enlace")
    .pt("Intensidade|do Link")
    .fr("Intensité|du Couplage")
    .ja("リンクパーセンテージ")
    .ko("링크 정도")
    .zhHans("连结程度")
    .zhHant("連結程度")
...
ts.append(T(tag="ParamLabel/text",
    text="Link|Side Gain")
    .es("Ganancia de|enlace de Side")
    .pt("Ganho|Side")
    .fr("Gain de Side|du Couplage")
    .ja("リンクサイドゲイン")
    .ko("링크 사이드 게인")
    .zhHans("连结侧信号增益")
    .zhHant("連結側信號增益")
    .ar("وصل الربح |الجانبي")
    .he(0)
)
...
ts.append(T(tag="ParamLabel/text",
    text="Sidechain|HPF")
    .es("Filtro pasa altos|de Sidechain")
    .pt("Filtro Passa-Altas|do Sidechain")
    .fr("Passe-Haut|du Sidechain")
    .ja("サイドチェインHPF")
    .ko("사이드체인 HPF")
    .zhHans("旁链高通滤波器")
    .zhHant("旁鏈高通濾波器")
    .ar("مرشح الترددا| العالية للسايدشين")
    .he(0)
)

ts.append(T(tag="ParamLabel/text",
    text="Sidechain|Trim")
    .es("Ajuste|de Sidechain")
    .pt("Sidechain|Volume")
    .fr("Volume|du Sidechain")
    .ja("サイドチェイントリム")
    .ko("사이드체인 트림")
    .zhHans("旁链修剪")
    .zhHant("旁鏈修剪")
    .ar("مُوازَنةٌ |السايدشين")
    .he(0)
)
